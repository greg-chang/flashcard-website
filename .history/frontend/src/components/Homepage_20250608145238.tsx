...
export default function Homepage() {
  return (
    <Flex minH="100vh" direction="column" bg="#FFFBF5" color="black" fontFamily="var(--font-dm-sans)">
      ...
      {/* Style Line as a separate element (flow line) */}
      <Box
        width="100%"
        height="150px" // Adjust height to be appropriate for a 'flow line'
        display="flex"
        justifyContent="center"
        alignItems="center"
        bg="red.500" // Set a very noticeable background color
      ...
      >
        <Image
          ...
          width={1200} // Set a large width to ensure it scales responsively
          height={150} // Aspect ratio for responsive image
          layout="responsive"
          objectFit="contain"
          style={{ filter: 'invert(1)' }} // Invert colors to make it visible on red background
        />
      </Box>
