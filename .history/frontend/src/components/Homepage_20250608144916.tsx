...
export default function Homepage() {
  return (
    <Flex minH="100vh" direction="column" bg="#FFFBF5" color="black" fontFamily="var(--font-dm-sans)">
      ...
      {/* Style Line as a separate element - Moved here */}
      <Box
        width="100%"
        display="flex"
      ...
      >
        <Image
          ...
          width={1200} // A large width to ensure it spreads across
          height={150} // Adjust height to control its visual impact
          layout="responsive"
          objectFit="contain"
          opacity="1" // Ensure full visibility
          style={{ filter: 'brightness(0) invert(1)' }} // Temporarily make it black for visibility test
        />
      </Box>
