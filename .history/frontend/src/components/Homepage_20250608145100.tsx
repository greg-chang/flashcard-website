...
export default function Homepage() {
  return (
    <Flex minH="100vh" direction="column" bg="#FFFBF5" color="black" fontFamily="var(--font-dm-sans)">
      ...
      {/* Style Line as a separate element */}
      <Box
        width="100%"
        height="150px" // Adjust height as needed for visibility
        display="flex"
        justifyContent="center"
        alignItems="center"
        py={4} // Add some vertical padding around the line
        bg="blue.300" // Temporary background for visibility test
