  ...
  return (
    <Flex minH="100vh" direction="column" bg="#FFFBF5" color="black" fontFamily="var(--font-dm-sans)">
      ...
      <Flex
        ...
        position="relative"
      >
        {/* Style Line as a separate element - Wrapped in Box for styling */}
        <Box
          position="absolute"
          bottom="0"
          left="0"
          width="100%"
          height="150px" // Adjust height to be visible as a line
          zIndex="0" // Ensure it's behind other content
          opacity="1" // Ensure full visibility for testing
          bg="blue.300" // Temporary background for testing visibility
          display="flex" // Use flex to center the image within this box
          justifyContent="center"
          alignItems="center"
        >
          <Image
            src={StyleLine}
            alt="Style Line Decorative Element"
            width={1200} // Large width for responsive scaling
            height={150} // Aspect ratio for responsive image
            layout="responsive"
            objectFit="contain"
            // Removed opacity and style from Image, applied to parent Box
          />
        </Box>
