...
import { FiPlus, FiUpload, FiBook, FiTag } from 'react-icons/fi';
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody pb={6}>
            ...
            <FormControl mt={4}>
              ...
              <Input
                ...
                value={newDeckLabels}
                onChange={(e) => setNewDeckLabels(e.target.value)}
              />
            </FormControl>
          </ModalBody>
          ...
          <ModalFooter>
            ...
            <Button colorScheme="green" onClick={handleCreateDeck} isLoading={isCreatingDeck}>
              Create
            </Button>
          </ModalFooter>
        </ModalContent>
